...
class model_pegasus(model_summerisation):
    def __init__(self, name_model_gz:str="google/pegasus-xsum") -> None:
        super().__init__(name_model_gz = name_model_gz)
    ...
    def load_model(self):
        ...
        print(f"LOG: Temps mis pour le chargement:{time() - t} seconds")
    ...
    def make_outputs(self, batch) :
        ...
        print(f"LOG: Temps mis pour {size} summerisations:{time() - t} seconds")
        return tgt_text
